defmodule HomelabWeb.HostLive.Signals do
  ...
  def render(%{embedded?: true} = assigns) do
    ~H"""
    <.host_panel current_time={@current_time} host_status={@host_status} />
    """
  end
  ...
  attr :current_time, :string, required: true
  attr :host_status, :map, required: true
